...
function ThinkingBlock({ thinking }) {
  ...
  return (
    <div className="mb-2">
      <button className="flex items-center gap-1.5 text-xs text-gray-400 hover:text-gray-600 transition-colors" onClick={() => setOpen(!open)}>
        <Brain size={13} />思考过程
...
function ToolCallCard({ tc }) {
  ...
  return (
    <div className="border border-gray-200 rounded-xl bg-gray-50 overflow-hidden text-xs">
      <button className="w-full flex items-center gap-2 px-3 py-2 hover:bg-gray-100 transition-colors text-left" onClick={() => setOpen(!open)}>
        {statusIcon}
